...
import { CalendarRange, Info, MapPin, Settings2, Calendar as IconCalendar, Icon } from "lucide-react-native";
  ...
  return (
    <View
      ...
      >
        ...
        <View 
          className="w-full absolute justify-end -bottom-1 self-center pb-5 z-10 bg-zinc-950"
        >
          <View
